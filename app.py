...
Original file is located at
    https://colab.research.google.com/drive/1p1jBPfNVUWGkz0HLnaj_v2EGQywgVDjF
"""
...
This app predicts the credit card default probability
...
def user_input_features():
  ...
  own_reality = st.selectbox('FLAG_OWN_REALITY',('Y','N'))
  ...
  name_income_type = st.selectbox("NAME_INCOME_TYPE",('Marketing','Commercial Associate','Pensioner','State Server','Student'))
  ...
  name_family_status = st.selectbox("NAME_FAMILY_STATUS",('Civil marriege','Married','Single/ not married','Seperated','Widow'))
  name_housing_type = st.selectbox("NAME_HOUSING_TYPE",('Rented Apartment','House / apartment','Municipal apartment','With Parents','C-op apartment','Office apartment'))
...
binary_features = ['CODE_GENDER','FLAG_OWN_CAR','FLAG_OWN_REALITY','FLAG_WORK_PHONE','FLAG_EMAIL']
...
df['FLAG_OWN_REALITY'] = df['FLAG_OWN_REALITY'].replace({'Y':1,'N':0})
...
df = df.rename(columns={'FLAG_EMAIL':'FLAG_EMAIL_1',
                        ...
                        'FLAG_OWN_REALITY':'FLAG_OWN_REALITY_Y'})
